...
void setup_nnlist(){
  ...
  list.cutoff_buffer2 = 0.5*(list.cutoff-pot.rcutoff); 
...
void create_cell_list(Slice *psl){
  ...
  for (i=0;i<psl->nparts;i++) { /*In which cell does the particle lie?  */
...
void print_cell_list(Slice *psl){
